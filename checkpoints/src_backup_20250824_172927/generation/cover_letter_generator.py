...
class CoverLetterGenerator(LoggerMixin):
    ...
    def generate_cover_letter(self, job_data: JobData, match_result: MatchResult,
        ...
        2. TOTAL LENGTH: EXACTLY 1250 characters maximum (including spaces) - plan your content accordingly
        ...
        7. METRIC ALIGNMENT: Choose the most relevant bullet point from CV that matches the role's primary objectives:
           - For GROWTH roles: Focus on conversion rates, revenue growth, user acquisition, funnel optimization
           - For DATA roles: Focus on analytics, insights, data-driven decisions, KPI improvements
           - For PRODUCT roles: Focus on feature adoption, user satisfaction, product-market fit
           - Use the EXACT metrics from the chosen bullet point, don't change them

        PARAGRAPH STRUCTURE:
        - Paragraph 1 (Introduction): Brief introduction and key achievements relevant to the role
        - Paragraph 2 (Case Study): Develop ONE specific case/project from your CV that best relates to what this role seeks. IMPORTANT: For Growth roles, focus on GROWTH METRICS (conversion rates, revenue growth, user acquisition, funnel optimization) - NOT general engagement metrics
        - Paragraph 3 (Closure): Value proposition and closing statement

        TEMPLATE STRUCTURE:
        Dear [Company] Recruitment Team,

        [Paragraph 1: Introduction and key achievements - ~300 chars]

        [Paragraph 2: Specific case/project example - ~400 chars]

        [Paragraph 3: Value proposition and closing - ~300 chars]
        ...
        Generate a compelling cover letter that fits exactly within 1250 characters:
        """
